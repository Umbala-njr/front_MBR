...
const EtapeafficheByMBR = () => {
  ...
  // Vérification d'une petite étape - SUPPRIMÉ LA RESTRICTION DE RÔLE
              ...
              >
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button
                    ...
                    className="bg-gradient-to-r from-emerald-500 to-emerald-600 text-white font-semibold py-2 px-4 rounded-xl shadow hover:shadow-md hover:from-emerald-600 hover:to-emerald-700 transform hover:scale-[1.02] transition-all duration-200 flex items-center space-x-2"
                  >
                          ...
                          >
                            ...
                            <div className="p-4 border-b border-gray-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                              ...
                              <div className="flex flex-col sm:flex-row gap-2">
                                {/* Vérification - SUPPRIMÉ LA RESTRICTION DE RÔLE */}
                                <button
                                ...
                                <button
                                  ...
                                  className="px-3 py-1 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg shadow transition flex items-center gap-2 text-sm"
                                >
...
export default EtapeafficheByMBR;