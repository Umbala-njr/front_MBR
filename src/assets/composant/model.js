 ...
 const { id_mbr, code_fab } = useParams();
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      // Trier les étapes par id_eta pour avoir une numérotation cohérente
      const sortedEtapes = etapes.sort((a, b) => a.id_eta - b.id_eta);
        ...
        {etapes.length > 0 ? (
          ...
          <div className="text-center py-20">
            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-12 max-w-md mx-auto">
              ...
              <h3 className="text-2xl font-bold text-white mb-2">Aucune étape trouvée</h3>
