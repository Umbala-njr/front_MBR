...
const FabricationMetList = () => {
  ...
  const handleAfficher = (code_fab) => {
    ...
    navigate(`/AQ/methode/${code_fab}`);
    console.log(`Navigation vers /AQ/methode/${code_fab}`);
  };
...
export default FabricationMetList;