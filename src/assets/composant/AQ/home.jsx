    ...
    <div className="w-full min-h-full bg-gradient-to-br from-gray-50 via-blue-50 to-green-50">
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-8">
        ...
        <div className="text-center">
          <h1 className="text-3xl lg:text-4xl font-bold bg-gradient-to-r from-blue-600 via-green-600 to-teal-600 bg-clip-text text-transparent mb-2">
        ...
        {/* MBR en cours */}
        <section className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg p-6 border border-white/20">
