...
import { FileText, Workflow, ClipboardList, ChevronRight, Home } from "lucide-react"; // ✅ ajout de ClipboardList
import axios from "axios";

const NavigationAQMBR = () => {
  ...
  const pages = [
    {
      label: "Fiche matière et solvant ...",
      path: `/AQ/matiereAQ/${id_mbr}/${code_fab}`,
      icon: <FileText className="w-5 h-5" />,
    },
    {
      label: "Check list des échantillons",
      path: `/AQ/echantillonAQ/${id_mbr}/${code_fab}`,
      icon: <ClipboardList className="w-5 h-5" />, // ✅ corrigé
    },
    {
      label: "Étape",
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-emerald-700 to-emerald-700 flex items-center justify-center">
...
export default NavigationAQMBR;
